...
if (demoCase === 8) {
    ...
    commands.push(
        ...
        () => bracket.addPlayer(1, 3, 'UPPER', '🇯🇵 Japan'),
        () => bracket.addPlayer(1, 3, 'BOTTOM', '🇭🇷 Croatia'),
        () => bracket.addPlayer(1, 4, 'UPPER', '🇧🇷 Brazil'),
        () => bracket.addPlayer(1, 4, 'BOTTOM', '🇰🇷 South Korea'),
        () => bracket.addPlayer(1, 5, 'UPPER', '🏴󠁧󠁢󠁥󠁮󠁧󠁿 England'),
        () => bracket.addPlayer(1, 5, 'BOTTOM', '🇸🇳 Senegal'),
        () => bracket.addPlayer(1, 6, 'UPPER', '🇫🇷 France'),
        () => bracket.addPlayer(1, 6, 'BOTTOM', '🇵🇱 Poland'),
        ...
        // Quarterfinals
        () => bracket.addPlayer(2, 1, 'UPPER', '🇳🇱 Netherlands'),
        () => bracket.addPlayer(2, 1, 'BOTTOM', '🇦🇷 Argentina'),
        () => bracket.addPlayer(2, 2, 'UPPER', '🇭🇷 Croatia'),
        () => bracket.addPlayer(2, 2, 'BOTTOM', '🇧🇷 Brazil'),
        () => bracket.addPlayer(2, 3, 'UPPER', '🏴󠁧󠁢󠁥󠁮󠁧󠁿 England'),
        () => bracket.addPlayer(2, 3, 'BOTTOM', '🇫🇷 France'),
